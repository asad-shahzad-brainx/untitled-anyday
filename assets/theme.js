...
class VariantSelects extends HTMLElement {
  ...
  updateVariantInput() {
    const productForms = document.querySelectorAll(
      `#ProductForm-${this.dataset.section}, #ProductFormInstallment-${this.dataset.section}`
    );
  ...
  toggleBuyButton(disable = true, text, modifyClass = true) {
    ...
    productForms.forEach((productForm) => {
      ...
      const buyButtonText = productForm.querySelector(
        '[name="add"] > .btn-text'
      );
      const buyButtonTextChild = productForm.querySelector(
      ...
      if (disable) {
        ...
        (buyButtonTextChild || buyButtonText).innerText =
          buyButton.dataset.preOrder === "true"
...
class CountdownTimer extends HTMLElement {
  ...
  get isCompact() {
    return (
      ...
      (this.dataset.compact === "mobile" && theme.config.mqlSmall)
    );
  }
